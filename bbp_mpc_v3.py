...
parser = argparse.ArgumentParser(description='BayesMPC')
...
def main():
    ...
    if args.cb:
        Log_file_path = './' + qoe_metric + '/cb_' + dataset + '/log_sim_bayesmpc'
    else:
        Log_file_path = './' + qoe_metric + '/' + dataset + '/log_sim_bayesmpc'
